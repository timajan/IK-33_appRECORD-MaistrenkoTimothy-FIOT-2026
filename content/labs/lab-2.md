...
![Ініціалізація бази](/assets/labs/lab-2/screen-1.png)
Ініціалізація бази в коді

![Моделі БД](/assets/labs/lab-2/screen-3.png)
Написання моделі Station
...
![Використання Sequelize](/assets/labs/lab-2/screen-2.png)
Написання роутів з викоистанням Sequelize
...
![Get](/assets/labs/lab-2/screen-5.png)
Отримання списку станцій

![Post](/assets/labs/lab-2/screen-6.png)
Створення велосипеда

![Put](/assets/labs/lab-2/screen-7.png)
Редагування велосипеда. Оскільки ми намагаємося редагувати ресурсу якого не існує, то ми отримуємо 404

![Delete](/assets/labs/lab-2/screen-8.png)
